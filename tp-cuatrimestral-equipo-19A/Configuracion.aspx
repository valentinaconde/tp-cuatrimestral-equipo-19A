    ...
    <div class="container mt-5">
        ...
        <div class="card-body">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <asp:TextBox runat="server"  placeholder="Buscar usuario..." ID="txtFiltro" CssClass="form-control mt-3" AutoPostBack="true" OnTextChanged="Buscar_TextChanged" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow mt-5">
            ...
            <div class="card-body">
                ...
                <asp:Label ID="lblNoResults" runat="server" CssClass="text-danger" Visible="false" Text="No se encontraron usuarios." />
            </div>
        </div>
    </div>
</asp:Content>
